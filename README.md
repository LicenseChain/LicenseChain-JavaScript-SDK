...
> Note: This is the browser/isomorphic **LicenseChain-JavaScript-SDK**. For server-only Node.js, use **LicenseChain-NodeJS-SDK**. See [docs.licensechain.app](https://docs.licensechain.app/).
## API Base

- Canonical API base: `https://api.licensechain.app/v1`
- API docs: [docs.licensechain.app](https://docs.licensechain.app/)
...
```javascript
import { verifyLicenseAssertionJwt } from '@licensechain/javascript-sdk';
// or: const { verifyLicenseAssertionJwt } = require('@licensechain/javascript-sdk');
```
